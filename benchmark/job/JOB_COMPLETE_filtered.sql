...
-- Query 18
-- 15a
SELECT MIN(movie_info.info), MIN(title.title) FROM aka_title, company_name, company_type, info_type, keyword, movie_companies, movie_info, movie_keyword, title WHERE company_name.country_code = '[us]' AND info_type.info = 'release dates' AND movie_companies.note LIKE '%(200%)%' AND movie_companies.note LIKE '%(worldwide)%' AND movie_info.note LIKE '%internet%' AND movie_info.info LIKE 'USA:% 200%' AND title.production_year > 2000 AND title.id = aka_title.movie_id AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND title.id = movie_companies.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = aka_title.movie_id AND movie_info.movie_id = movie_companies.movie_id AND movie_info.movie_id = aka_title.movie_id AND movie_companies.movie_id = aka_title.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info.info_type_id AND company_name.id = movie_companies.company_id AND company_type.id = movie_companies.company_type_id;

-- Query 19
-- 15b
SELECT MIN(movie_info.info), MIN(title.title) FROM aka_title, company_name, company_type, info_type, keyword, movie_companies, movie_info, movie_keyword, title WHERE company_name.country_code = '[us]' AND company_name.name = 'YouTube' AND info_type.info = 'release dates' AND movie_companies.note LIKE '%(200%)%' AND movie_companies.note LIKE '%(worldwide)%' AND movie_info.note LIKE '%internet%' AND movie_info.info LIKE 'USA:% 200%' AND title.production_year >= 2005 AND title.production_year <= 2010 AND title.id = aka_title.movie_id AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND title.id = movie_companies.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = aka_title.movie_id AND movie_info.movie_id = movie_companies.movie_id AND movie_info.movie_id = aka_title.movie_id AND movie_companies.movie_id = aka_title.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info.info_type_id AND company_name.id = movie_companies.company_id AND company_type.id = movie_companies.company_type_id;

-- Query 20
-- 15c
SELECT MIN(movie_info.info), MIN(title.title) FROM aka_title, company_name, company_type, info_type, keyword, movie_companies, movie_info, movie_keyword, title WHERE company_name.country_code = '[us]' AND info_type.info = 'release dates' AND movie_info.note LIKE '%internet%' AND (movie_info.info LIKE 'USA:% 199%' OR movie_info.info LIKE 'USA:% 200%') AND title.production_year > 1990 AND title.id = aka_title.movie_id AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND title.id = movie_companies.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = aka_title.movie_id AND movie_info.movie_id = movie_companies.movie_id AND movie_info.movie_id = aka_title.movie_id AND movie_companies.movie_id = aka_title.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info.info_type_id AND company_name.id = movie_companies.company_id AND company_type.id = movie_companies.company_type_id;

-- Query 21
-- 15d
SELECT MIN(aka_title.title), MIN(title.title) FROM aka_title, company_name, company_type, info_type, keyword, movie_companies, movie_info, movie_keyword, title WHERE company_name.country_code = '[us]' AND info_type.info = 'release dates' AND movie_info.note LIKE '%internet%' AND title.production_year > 1990 AND title.id = aka_title.movie_id AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND title.id = movie_companies.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = aka_title.movie_id AND movie_info.movie_id = movie_companies.movie_id AND movie_info.movie_id = aka_title.movie_id AND movie_companies.movie_id = aka_title.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info.info_type_id AND company_name.id = movie_companies.company_id AND company_type.id = movie_companies.company_type_id;

-- Query 22
-- 16a
SELECT MIN(aka_name.name), MIN(title.title) FROM aka_name, cast_info, company_name, keyword, movie_companies, movie_keyword, name, title WHERE company_name.country_code ='[us]' AND keyword.keyword ='character-name-in-title' AND title.episode_nr >= 50 AND title.episode_nr < 100 AND aka_name.person_id = name.id AND name.id = cast_info.person_id AND cast_info.movie_id = title.id AND title.id = movie_keyword.movie_id AND movie_keyword.keyword_id = keyword.id AND title.id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND aka_name.person_id = cast_info.person_id AND cast_info.movie_id = movie_companies.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND movie_companies.movie_id = movie_keyword.movie_id;
...
-- Query 29
-- 17d
SELECT MIN(name.name) FROM cast_info, company_name, keyword, movie_companies, movie_keyword, name, title WHERE keyword.keyword ='character-name-in-title' AND name.name LIKE '%Bert%' AND name.id = cast_info.person_id AND cast_info.movie_id = title.id AND title.id = movie_keyword.movie_id AND movie_keyword.keyword_id = keyword.id AND title.id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.movie_id = movie_companies.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND movie_companies.movie_id = movie_keyword.movie_id;
...
-- Query 35
-- 19a
SELECT MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, movie_companies, movie_info, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND info_type.info = 'release dates' AND (movie_companies.note LIKE '%(USA)%' OR movie_companies.note LIKE '%(worldwide)%') AND (movie_info.info LIKE 'Japan:%200%' OR movie_info.info LIKE 'USA:%200%') AND name.gender ='f' AND name.name LIKE '%Ang%' AND role_type.role ='actress' AND title.production_year >= 2005 AND title.production_year <= 2009 AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_info.movie_id = cast_info.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id;

-- Query 36
-- 19b
SELECT MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, movie_companies, movie_info, name, role_type, title WHERE cast_info.note = '(voice)' AND company_name.country_code ='[us]' AND info_type.info = 'release dates' AND movie_companies.note LIKE '%(200%)%' AND (movie_companies.note LIKE '%(USA)%' OR movie_companies.note LIKE '%(worldwide)%') AND (movie_info.info LIKE 'Japan:%2007%' OR movie_info.info LIKE 'USA:%2008%') AND name.gender ='f' AND name.name LIKE '%Angel%' AND role_type.role ='actress' AND title.production_year >= 2007 AND title.production_year <= 2008 AND title.title LIKE '%Kung%Fu%Panda%' AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_info.movie_id = cast_info.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id;

-- Query 37
-- 19c
SELECT MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, movie_companies, movie_info, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND info_type.info = 'release dates' AND (movie_info.info LIKE 'Japan:%200%' OR movie_info.info LIKE 'USA:%200%') AND name.gender ='f' AND name.name LIKE '%An%' AND role_type.role ='actress' AND title.production_year > 2000 AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_info.movie_id = cast_info.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id;

-- Query 38
-- 19d
SELECT MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, movie_companies, movie_info, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND info_type.info = 'release dates' AND name.gender ='f' AND role_type.role ='actress' AND title.production_year > 2000 AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_info.movie_id = cast_info.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id;

-- Query 39
-- 1a
SELECT MIN(movie_companies.note), MIN(title.title), MIN(title.production_year) FROM company_type, info_type, movie_companies, movie_info_idx, title WHERE company_type.kind = 'production companies' AND info_type.info = 'top 250 rank' AND (movie_companies.note LIKE '%(co-production)%' OR movie_companies.note LIKE '%(presents)%') AND company_type.id = movie_companies.company_type_id AND title.id = movie_companies.movie_id AND title.id = movie_info_idx.movie_id AND movie_companies.movie_id = movie_info_idx.movie_id AND info_type.id = movie_info_idx.info_type_id;

-- Query 40
-- 1b
SELECT MIN(movie_companies.note), MIN(title.title), MIN(title.production_year) FROM company_type, info_type, movie_companies, movie_info_idx, title WHERE company_type.kind = 'production companies' AND info_type.info = 'bottom 10 rank' AND title.production_year >= 2005 AND title.production_year <= 2010 AND company_type.id = movie_companies.company_type_id AND title.id = movie_companies.movie_id AND title.id = movie_info_idx.movie_id AND movie_companies.movie_id = movie_info_idx.movie_id AND info_type.id = movie_info_idx.info_type_id;
...
-- Query 45
-- 20c
SELECT MIN(name.name), MIN(title.title) FROM complete_cast, comp_cast_type, comp_cast_type, char_name, cast_info, keyword, kind_type, movie_keyword, name, title WHERE comp_cast_type.kind = 'cast' AND comp_cast_type.kind LIKE '%complete%' AND (char_name.name LIKE '%man%' OR char_name.name LIKE '%Man%') AND (keyword.keyword = 'superhero' OR keyword.keyword = 'marvel-comics' OR keyword.keyword = 'based-on-comic' OR keyword.keyword = 'tv-special' OR keyword.keyword = 'fight' OR keyword.keyword = 'violence' OR keyword.keyword = 'magnet' OR keyword.keyword = 'web' OR keyword.keyword = 'claw' OR keyword.keyword = 'laser') AND kind_type.kind = 'movie' AND title.production_year > 2000 AND kind_type.id = title.kind_id AND title.id = movie_keyword.movie_id AND title.id = cast_info.movie_id AND title.id = complete_cast.movie_id AND movie_keyword.movie_id = cast_info.movie_id AND movie_keyword.movie_id = complete_cast.movie_id AND cast_info.movie_id = complete_cast.movie_id AND char_name.id = cast_info.person_role_id AND name.id = cast_info.person_id AND keyword.id = movie_keyword.keyword_id AND comp_cast_type.id = complete_cast.subject_id AND comp_cast_type.id = complete_cast.status_id;

-- Query 46
-- 21a
SELECT MIN(company_name.name), MIN(link_type.link), MIN(title.title) FROM company_name, company_type, keyword, link_type, movie_companies, movie_info, movie_keyword, movie_link, title WHERE (company_name.name LIKE '%Film%' OR company_name.name LIKE '%Warner%') AND company_type.kind ='production companies' AND keyword.keyword ='sequel' AND link_type.link LIKE '%follow%' AND (movie_info.info = 'Sweden' OR movie_info.info = 'Norway' OR movie_info.info = 'Germany' OR movie_info.info = 'Denmark' OR movie_info.info = 'Swedish' OR movie_info.info = 'Denish' OR movie_info.info = 'Norwegian' OR movie_info.info = 'German') AND title.production_year >= 1950 AND title.production_year <= 2000 AND link_type.id = movie_link.link_type_id AND movie_link.movie_id = title.id AND title.id = movie_keyword.movie_id AND movie_keyword.keyword_id = keyword.id AND title.id = movie_companies.movie_id AND movie_companies.company_type_id = company_type.id AND movie_companies.company_id = company_name.id AND movie_info.movie_id = title.id AND movie_link.movie_id = movie_keyword.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_link.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_companies.movie_id = movie_info.movie_id;

-- Query 47
-- 21b
SELECT MIN(company_name.name), MIN(link_type.link), MIN(title.title) FROM company_name, company_type, keyword, link_type, movie_companies, movie_info, movie_keyword, movie_link, title WHERE (company_name.name LIKE '%Film%' OR company_name.name LIKE '%Warner%') AND company_type.kind ='production companies' AND keyword.keyword ='sequel' AND link_type.link LIKE '%follow%' AND (movie_info.info = 'Germany' OR movie_info.info = 'German') AND title.production_year >= 2000 AND title.production_year <= 2010 AND link_type.id = movie_link.link_type_id AND movie_link.movie_id = title.id AND title.id = movie_keyword.movie_id AND movie_keyword.keyword_id = keyword.id AND title.id = movie_companies.movie_id AND movie_companies.company_type_id = company_type.id AND movie_companies.company_id = company_name.id AND movie_info.movie_id = title.id AND movie_link.movie_id = movie_keyword.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_link.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_companies.movie_id = movie_info.movie_id;

-- Query 48
-- 21c
SELECT MIN(company_name.name), MIN(link_type.link), MIN(title.title) FROM company_name, company_type, keyword, link_type, movie_companies, movie_info, movie_keyword, movie_link, title WHERE (company_name.name LIKE '%Film%' OR company_name.name LIKE '%Warner%') AND company_type.kind ='production companies' AND keyword.keyword ='sequel' AND link_type.link LIKE '%follow%' AND (movie_info.info = 'Sweden' OR movie_info.info = 'Norway' OR movie_info.info = 'Germany' OR movie_info.info = 'Denmark' OR movie_info.info = 'Swedish' OR movie_info.info = 'Denish' OR movie_info.info = 'Norwegian' OR movie_info.info = 'German' OR movie_info.info = 'English') AND title.production_year >= 1950 AND title.production_year <= 2010 AND link_type.id = movie_link.link_type_id AND movie_link.movie_id = title.id AND title.id = movie_keyword.movie_id AND movie_keyword.keyword_id = keyword.id AND title.id = movie_companies.movie_id AND movie_companies.company_type_id = company_type.id AND movie_companies.company_id = company_name.id AND movie_info.movie_id = title.id AND movie_link.movie_id = movie_keyword.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_link.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_companies.movie_id = movie_info.movie_id;

-- Query 49
-- 22a
SELECT MIN(company_name.name), MIN(movie_info_idx.info), MIN(title.title) FROM company_name, company_type, info_type, info_type, keyword, kind_type, movie_companies, movie_info, movie_info_idx, movie_keyword, title WHERE info_type.info = 'countries' AND info_type.info = 'rating' AND (keyword.keyword = 'murder' OR keyword.keyword = 'murder-in-title' OR keyword.keyword = 'blood' OR keyword.keyword = 'violence') AND (kind_type.kind = 'movie' OR kind_type.kind = 'episode') AND movie_companies.note LIKE '%(200%)%' AND (movie_info.info = 'Germany' OR movie_info.info = 'German' OR movie_info.info = 'USA' OR movie_info.info = 'American') AND movie_info_idx.info < '7.0' AND title.production_year > 2008 AND kind_type.id = title.kind_id AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND title.id = movie_info_idx.movie_id AND title.id = movie_companies.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND movie_keyword.movie_id = movie_info_idx.movie_id AND movie_keyword.movie_id = movie_companies.movie_id AND movie_info.movie_id = movie_info_idx.movie_id AND movie_info.movie_id = movie_companies.movie_id AND movie_companies.movie_id = movie_info_idx.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info.info_type_id AND info_type.id = movie_info_idx.info_type_id AND company_type.id = movie_companies.company_type_id AND company_name.id = movie_companies.company_id;
...
-- Query 56
-- 24a
SELECT MIN(char_name.name), MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, keyword, movie_companies, movie_info, movie_keyword, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND info_type.info = 'release dates' AND (keyword.keyword = 'hero' OR keyword.keyword = 'martial-arts' OR keyword.keyword = 'hand-to-hand-combat') AND (movie_info.info LIKE 'Japan:%201%' OR movie_info.info LIKE 'USA:%201%') AND name.gender ='f' AND name.name LIKE '%An%' AND role_type.role ='actress' AND title.production_year > 2010 AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND title.id = movie_keyword.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_companies.movie_id = movie_keyword.movie_id AND movie_info.movie_id = cast_info.movie_id AND movie_info.movie_id = movie_keyword.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id AND keyword.id = movie_keyword.keyword_id;

-- Query 57
-- 24b
SELECT MIN(char_name.name), MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, info_type, keyword, movie_companies, movie_info, movie_keyword, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND company_name.name = 'DreamWorks Animation' AND info_type.info = 'release dates' AND (keyword.keyword = 'hero' OR keyword.keyword = 'martial-arts' OR keyword.keyword = 'hand-to-hand-combat' OR keyword.keyword = 'computer-animated-movie') AND (movie_info.info LIKE 'Japan:%201%' OR movie_info.info LIKE 'USA:%201%') AND name.gender ='f' AND name.name LIKE '%An%' AND role_type.role ='actress' AND title.production_year > 2010 AND title.title LIKE 'Kung Fu Panda%' AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND title.id = cast_info.movie_id AND title.id = movie_keyword.movie_id AND movie_companies.movie_id = cast_info.movie_id AND movie_companies.movie_id = movie_info.movie_id AND movie_companies.movie_id = movie_keyword.movie_id AND movie_info.movie_id = cast_info.movie_id AND movie_info.movie_id = movie_keyword.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND company_name.id = movie_companies.company_id AND info_type.id = movie_info.info_type_id AND name.id = cast_info.person_id AND role_type.id = cast_info.role_id AND name.id = aka_name.person_id AND cast_info.person_id = aka_name.person_id AND char_name.id = cast_info.person_role_id AND keyword.id = movie_keyword.keyword_id;

-- Query 58
-- 25a
SELECT MIN(movie_info.info), MIN(movie_info_idx.info), MIN(name.name), MIN(title.title) FROM cast_info, info_type, info_type, keyword, movie_info, movie_info_idx, movie_keyword, name, title WHERE (cast_info.note = '(writer)' OR cast_info.note = '(head writer)' OR cast_info.note = '(written by)' OR cast_info.note = '(story)' OR cast_info.note = '(story editor)') AND info_type.info = 'genres' AND info_type.info = 'votes' AND (keyword.keyword = 'murder' OR keyword.keyword = 'blood' OR keyword.keyword = 'gore' OR keyword.keyword = 'death' OR keyword.keyword = 'female-nudity') AND movie_info.info = 'Horror' AND name.gender = 'm' AND title.id = movie_info.movie_id AND title.id = movie_info_idx.movie_id AND title.id = cast_info.movie_id AND title.id = movie_keyword.movie_id AND cast_info.movie_id = movie_info.movie_id AND cast_info.movie_id = movie_info_idx.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND movie_info.movie_id = movie_info_idx.movie_id AND movie_info.movie_id = movie_keyword.movie_id AND movie_info_idx.movie_id = movie_keyword.movie_id AND name.id = cast_info.person_id AND info_type.id = movie_info.info_type_id AND info_type.id = movie_info_idx.info_type_id AND keyword.id = movie_keyword.keyword_id;
...
-- Query 83
-- 32a
SELECT MIN(link_type.link), MIN(title.title), MIN(title.title) FROM keyword, link_type, movie_keyword, movie_link, title, title WHERE keyword.keyword ='10,000-mile-club' AND movie_keyword.keyword_id = keyword.id AND title.id = movie_keyword.movie_id AND movie_link.movie_id = title.id AND movie_link.linked_movie_id = title.id AND link_type.id = movie_link.link_type_id AND movie_keyword.movie_id = title.id;

-- Query 84
-- 32b
SELECT MIN(link_type.link), MIN(title.title), MIN(title.title) FROM keyword, link_type, movie_keyword, movie_link, title, title WHERE keyword.keyword ='character-name-in-title' AND movie_keyword.keyword_id = keyword.id AND title.id = movie_keyword.movie_id AND movie_link.movie_id = title.id AND movie_link.linked_movie_id = title.id AND link_type.id = movie_link.link_type_id AND movie_keyword.movie_id = title.id;

-- Query 85
-- 33a
SELECT MIN(company_name.name), MIN(company_name.name), MIN(movie_info_idx.info), MIN(movie_info_idx.info), MIN(title.title), MIN(title.title) FROM company_name, company_name, info_type, info_type, kind_type, kind_type, link_type, movie_companies, movie_companies, movie_info_idx, movie_info_idx, movie_link, title, title WHERE company_name.country_code = '[us]' AND info_type.info = 'rating' AND info_type.info = 'rating' AND (kind_type.kind = 'tv series') AND (kind_type.kind = 'tv series') AND (link_type.link = 'sequel' OR link_type.link = 'follows' OR link_type.link = 'followed by') AND movie_info_idx.info < '3.0' AND title.production_year >= 2005 AND title.production_year <= 2008 AND link_type.id = movie_link.link_type_id AND title.id = movie_link.movie_id AND title.id = movie_link.linked_movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.movie_id = movie_info_idx.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.linked_movie_id = movie_info_idx.movie_id AND movie_link.linked_movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id;

-- Query 86
-- 33b
SELECT MIN(company_name.name), MIN(company_name.name), MIN(movie_info_idx.info), MIN(movie_info_idx.info), MIN(title.title), MIN(title.title) FROM company_name, company_name, info_type, info_type, kind_type, kind_type, link_type, movie_companies, movie_companies, movie_info_idx, movie_info_idx, movie_link, title, title WHERE company_name.country_code = '[nl]' AND info_type.info = 'rating' AND info_type.info = 'rating' AND (kind_type.kind = 'tv series') AND (kind_type.kind = 'tv series') AND link_type.link LIKE '%follow%' AND movie_info_idx.info < '3.0' AND title.production_year = 2007 AND link_type.id = movie_link.link_type_id AND title.id = movie_link.movie_id AND title.id = movie_link.linked_movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.movie_id = movie_info_idx.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.linked_movie_id = movie_info_idx.movie_id AND movie_link.linked_movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id;

-- Query 87
-- 33c
SELECT MIN(company_name.name), MIN(company_name.name), MIN(movie_info_idx.info), MIN(movie_info_idx.info), MIN(title.title), MIN(title.title) FROM company_name, company_name, info_type, info_type, kind_type, kind_type, link_type, movie_companies, movie_companies, movie_info_idx, movie_info_idx, movie_link, title, title WHERE info_type.info = 'rating' AND info_type.info = 'rating' AND (kind_type.kind = 'tv series' OR kind_type.kind = 'episode') AND (kind_type.kind = 'tv series' OR kind_type.kind = 'episode') AND (link_type.link = 'sequel' OR link_type.link = 'follows' OR link_type.link = 'followed by') AND movie_info_idx.info < '3.5' AND title.production_year >= 2000 AND title.production_year <= 2010 AND link_type.id = movie_link.link_type_id AND title.id = movie_link.movie_id AND title.id = movie_link.linked_movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.movie_id = movie_info_idx.movie_id AND movie_link.movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id AND info_type.id = movie_info_idx.info_type_id AND title.id = movie_info_idx.movie_id AND kind_type.id = title.kind_id AND company_name.id = movie_companies.company_id AND title.id = movie_companies.movie_id AND movie_link.linked_movie_id = movie_info_idx.movie_id AND movie_link.linked_movie_id = movie_companies.movie_id AND movie_info_idx.movie_id = movie_companies.movie_id;

-- Query 88
-- 3a
SELECT MIN(title.title) FROM keyword, movie_info, movie_keyword, title WHERE keyword.keyword LIKE '%sequel%' AND (movie_info.info = 'Sweden' OR movie_info.info = 'Norway' OR movie_info.info = 'Germany' OR movie_info.info = 'Denmark' OR movie_info.info = 'Swedish' OR movie_info.info = 'Denish' OR movie_info.info = 'Norwegian' OR movie_info.info = 'German') AND title.production_year > 2005 AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND keyword.id = movie_keyword.keyword_id;

-- Query 89
-- 3b
SELECT MIN(title.title) FROM keyword, movie_info, movie_keyword, title WHERE keyword.keyword LIKE '%sequel%' AND (movie_info.info = 'Bulgaria') AND title.production_year > 2010 AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND keyword.id = movie_keyword.keyword_id;

-- Query 90
-- 3c
SELECT MIN(title.title) FROM keyword, movie_info, movie_keyword, title WHERE keyword.keyword LIKE '%sequel%' AND (movie_info.info = 'Sweden' OR movie_info.info = 'Norway' OR movie_info.info = 'Germany' OR movie_info.info = 'Denmark' OR movie_info.info = 'Swedish' OR movie_info.info = 'Denish' OR movie_info.info = 'Norwegian' OR movie_info.info = 'German' OR movie_info.info = 'USA' OR movie_info.info = 'American') AND title.production_year > 1990 AND title.id = movie_info.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info.movie_id AND keyword.id = movie_keyword.keyword_id;

-- Query 91
-- 4a
SELECT MIN(movie_info_idx.info), MIN(title.title) FROM info_type, keyword, movie_info_idx, movie_keyword, title WHERE info_type.info ='rating' AND keyword.keyword LIKE '%sequel%' AND movie_info_idx.info > '5.0' AND title.production_year > 2005 AND title.id = movie_info_idx.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info_idx.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info_idx.info_type_id;

-- Query 92
-- 4b
SELECT MIN(movie_info_idx.info), MIN(title.title) FROM info_type, keyword, movie_info_idx, movie_keyword, title WHERE info_type.info ='rating' AND keyword.keyword LIKE '%sequel%' AND movie_info_idx.info > '9.0' AND title.production_year > 2010 AND title.id = movie_info_idx.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info_idx.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info_idx.info_type_id;

-- Query 93
-- 4c
SELECT MIN(movie_info_idx.info), MIN(title.title) FROM info_type, keyword, movie_info_idx, movie_keyword, title WHERE info_type.info ='rating' AND keyword.keyword LIKE '%sequel%' AND movie_info_idx.info > '2.0' AND title.production_year > 1990 AND title.id = movie_info_idx.movie_id AND title.id = movie_keyword.movie_id AND movie_keyword.movie_id = movie_info_idx.movie_id AND keyword.id = movie_keyword.keyword_id AND info_type.id = movie_info_idx.info_type_id;

-- Query 94
-- 5a
SELECT MIN(title.title) FROM company_type, info_type, movie_companies, movie_info, title WHERE company_type.kind = 'production companies' AND movie_companies.note LIKE '%(theatrical)%' AND movie_companies.note LIKE '%(France)%' AND (movie_info.info = 'Sweden' OR movie_info.info = 'Norway' OR movie_info.info = 'Germany' OR movie_info.info = 'Denmark' OR movie_info.info = 'Swedish' OR movie_info.info = 'Denish' OR movie_info.info = 'Norwegian' OR movie_info.info = 'German') AND title.production_year > 2005 AND title.id = movie_info.movie_id AND title.id = movie_companies.movie_id AND movie_companies.movie_id = movie_info.movie_id AND company_type.id = movie_companies.company_type_id AND info_type.id = movie_info.info_type_id;
...
-- Query 97
-- 6a
SELECT MIN(keyword.keyword), MIN(name.name), MIN(title.title) FROM cast_info, keyword, movie_keyword, name, title WHERE keyword.keyword = 'marvel-cinematic-universe' AND name.name LIKE '%Downey%Robert%' AND title.production_year > 2010 AND keyword.id = movie_keyword.keyword_id AND title.id = movie_keyword.movie_id AND title.id = cast_info.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND name.id = cast_info.person_id;

-- Query 98
-- 6b
SELECT MIN(keyword.keyword), MIN(name.name), MIN(title.title) FROM cast_info, keyword, movie_keyword, name, title WHERE (keyword.keyword = 'superhero' OR keyword.keyword = 'sequel' OR keyword.keyword = 'second-part' OR keyword.keyword = 'marvel-comics' OR keyword.keyword = 'based-on-comic' OR keyword.keyword = 'tv-special' OR keyword.keyword = 'fight' OR keyword.keyword = 'violence') AND name.name LIKE '%Downey%Robert%' AND title.production_year > 2014 AND keyword.id = movie_keyword.keyword_id AND title.id = movie_keyword.movie_id AND title.id = cast_info.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND name.id = cast_info.person_id;

-- Query 99
-- 6c
SELECT MIN(keyword.keyword), MIN(name.name), MIN(title.title) FROM cast_info, keyword, movie_keyword, name, title WHERE keyword.keyword = 'marvel-cinematic-universe' AND name.name LIKE '%Downey%Robert%' AND title.production_year > 2014 AND keyword.id = movie_keyword.keyword_id AND title.id = movie_keyword.movie_id AND title.id = cast_info.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND name.id = cast_info.person_id;
...
-- Query 101
-- 6e
SELECT MIN(keyword.keyword), MIN(name.name), MIN(title.title) FROM cast_info, keyword, movie_keyword, name, title WHERE keyword.keyword = 'marvel-cinematic-universe' AND name.name LIKE '%Downey%Robert%' AND title.production_year > 2000 AND keyword.id = movie_keyword.keyword_id AND title.id = movie_keyword.movie_id AND title.id = cast_info.movie_id AND cast_info.movie_id = movie_keyword.movie_id AND name.id = cast_info.person_id;
...
-- Query 108
-- 8c
SELECT MIN(aka_name.name), MIN(title.title) FROM aka_name, cast_info, company_name, movie_companies, name, role_type, title WHERE company_name.country_code ='[us]' AND role_type.role ='writer' AND aka_name.person_id = name.id AND name.id = cast_info.person_id AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND aka_name.person_id = cast_info.person_id AND cast_info.movie_id = movie_companies.movie_id;

-- Query 109
-- 8d
SELECT MIN(aka_name.name), MIN(title.title) FROM aka_name, cast_info, company_name, movie_companies, name, role_type, title WHERE company_name.country_code ='[us]' AND role_type.role ='costume designer' AND aka_name.person_id = name.id AND name.id = cast_info.person_id AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND aka_name.person_id = cast_info.person_id AND cast_info.movie_id = movie_companies.movie_id;

-- Query 110
-- 9a
SELECT MIN(aka_name.name), MIN(char_name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, movie_companies, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND (movie_companies.note LIKE '%(USA)%' OR movie_companies.note LIKE '%(worldwide)%') AND name.gender ='f' AND name.name LIKE '%Ang%' AND role_type.role ='actress' AND title.production_year >= 2005 AND title.production_year <= 2015 AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND cast_info.movie_id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND name.id = cast_info.person_id AND char_name.id = cast_info.person_role_id AND aka_name.person_id = name.id AND aka_name.person_id = cast_info.person_id;

-- Query 111
-- 9b
SELECT MIN(aka_name.name), MIN(char_name.name), MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, movie_companies, name, role_type, title WHERE cast_info.note = '(voice)' AND company_name.country_code ='[us]' AND movie_companies.note LIKE '%(200%)%' AND (movie_companies.note LIKE '%(USA)%' OR movie_companies.note LIKE '%(worldwide)%') AND name.gender ='f' AND name.name LIKE '%Angel%' AND role_type.role ='actress' AND title.production_year >= 2007 AND title.production_year <= 2010 AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND cast_info.movie_id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND name.id = cast_info.person_id AND char_name.id = cast_info.person_role_id AND aka_name.person_id = name.id AND aka_name.person_id = cast_info.person_id;

-- Query 112
-- 9c
SELECT MIN(aka_name.name), MIN(char_name.name), MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, movie_companies, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND name.gender ='f' AND name.name LIKE '%An%' AND role_type.role ='actress' AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND cast_info.movie_id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND name.id = cast_info.person_id AND char_name.id = cast_info.person_role_id AND aka_name.person_id = name.id AND aka_name.person_id = cast_info.person_id;

-- Query 113
-- 9d
SELECT MIN(aka_name.name), MIN(char_name.name), MIN(name.name), MIN(title.title) FROM aka_name, char_name, cast_info, company_name, movie_companies, name, role_type, title WHERE (cast_info.note = '(voice)' OR cast_info.note = '(voice: Japanese version)' OR cast_info.note = '(voice) (uncredited)' OR cast_info.note = '(voice: English version)') AND company_name.country_code ='[us]' AND name.gender ='f' AND role_type.role ='actress' AND cast_info.movie_id = title.id AND title.id = movie_companies.movie_id AND cast_info.movie_id = movie_companies.movie_id AND movie_companies.company_id = company_name.id AND cast_info.role_id = role_type.id AND name.id = cast_info.person_id AND char_name.id = cast_info.person_role_id AND aka_name.person_id = name.id AND aka_name.person_id = cast_info.person_id;
