...
IMPORT INTO cast_info DSV "benchmark/job-light/data/cast_info.csv" ; -- ROWS 100000;
IMPORT INTO title DSV "benchmark/job-light/data/title.csv" ; -- ROWS 100000; 
IMPORT INTO movie_companies DSV "benchmark/job-light/data/movie_companies_cleaned.csv"; --  ROWS 100000; 
IMPORT INTO movie_info_idx DSV "benchmark/job-light/data/movie_info_idx_cleaned.csv"; --  ROWS 100000;
IMPORT INTO movie_keyword DSV "benchmark/job-light/data/movie_keyword.csv"; --  ROWS 100000;
IMPORT INTO movie_info DSV "benchmark/job-light/data/movie_info.csv"; --  ROWS 100000; 
